...
\footnotetext{AI tools were used to assist with drafting and editing. The authors are responsible for the ideas, claims, proofs, citations, and final text.}

\input{sections/01_introduction}
\input{sections/08_related_work}
\input{sections/02_supported_process}
\input{sections/03_support_dependency}
\input{sections/04_phenomenon_realization}
\input{sections/05_distributed_realization}
\input{sections/06_support_restriction}
\input{sections/07_supported_windows}
